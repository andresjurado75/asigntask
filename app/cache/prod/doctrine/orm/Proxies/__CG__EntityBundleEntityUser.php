...
class User extends \EntityBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'EntityBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'EntityBundle\\Entity\\User' . "\0" . 'name', '' . "\0" . 'EntityBundle\\Entity\\User' . "\0" . 'lastname', '' . "\0" . 'EntityBundle\\Entity\\User' . "\0" . 'nuip', '' . "\0" . 'EntityBundle\\Entity\\User' . "\0" . 'tel', '' . "\0" . 'EntityBundle\\Entity\\User' . "\0" . 'tasks');
        }
