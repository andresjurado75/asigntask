 ...
 */
class Task extends \EntityBundle\Entity\Task implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'EntityBundle\\Entity\\Task' . "\0" . 'id', '' . "\0" . 'EntityBundle\\Entity\\Task' . "\0" . 'createdAt', '' . "\0" . 'EntityBundle\\Entity\\Task' . "\0" . 'contenido', '' . "\0" . 'EntityBundle\\Entity\\Task' . "\0" . 'updatedAt', '' . "\0" . 'EntityBundle\\Entity\\Task' . "\0" . 'state', '' . "\0" . 'EntityBundle\\Entity\\Task' . "\0" . 'title', '' . "\0" . 'EntityBundle\\Entity\\Task' . "\0" . 'user');
        }
